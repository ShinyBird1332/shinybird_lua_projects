...
--возможно ли создавать новые реакторы
--возможно ли создание жидкого красного камня
--доступен ли робот
--есть ли генератор для создания урана
...
--идея: сделать программу, которая будет контролировать существующие реакторы, контролировать генераторы материи, 
--которые обеспечивают его ураном
