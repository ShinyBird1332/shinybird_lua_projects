...
function reactor.filling_or_roof_reactor(block1, block2, block3, block4, block5)
    block5 = block5 or "Reactor Casing"
    ...
    functions.build_row(block1, "Reactor Casing", block5, constants.SIZE)
