...
--новая идея:
--сделать огромный магаз со всеми исследованиями
--обменник: свиток = открытие (надо что-то придумать со стоимостью)
...
--!ребят, открываю уникальный warp tc! Автоматическое изучение любых свитков из таумкрафта!